...
# Profil bağlantılarının bulunduğu alan (field-item class'ı altında)
profile_links = []

# field-item class'ı altındaki <a> tag'larını buluyoruz
for div_tag in soup.find_all('div', class_="fio"):
...
for link in profile_links:
    # Profil sayfasının tam URL'sini almak için
    profile_url = urljoin(base_url, link)  
    
    print(f"Profil sayfası: {profile_url}")  # Hangi profil sayfasına gidildiğini görmek için
